...
SITE_LIST_DEFAULT=("github.com:443")
SITE_LIST_DEFAULT+=("dl-cdn.alpinelinux.org:443")
...
function install_macos_python_cacert() {
  local LOG_PREFIX="install_macos_python_cacert():"
...
function usage() {
  ...
  echo "  Examples:"
	...
	echo "       ${0} -L DEBUG"
  echo "       ${0} -v"
	echo "       ${0} bitbucket.alsac.stjude.org:8443 updates.jenkins.io:443"
